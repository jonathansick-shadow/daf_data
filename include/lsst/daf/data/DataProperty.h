...
#ifndef LSST_MWI_DATA_DATAPROPERTY_H
#define LSST_MWI_DATA_DATAPROPERTY_H
...
/** 
  ...
  * 
  */
class DataProperty : public lsst::mwi::persistence::Persistable, public Citizen
{
...
private:
    LSST_PERSIST_FORMATTER(DataPropertyFormatter);
...
// BOOST_CLASS_EXPORT(lsst::mwi::data::DataProperty);

#endif // LSST_MWI_DATA_DATAPROPERTY_H
